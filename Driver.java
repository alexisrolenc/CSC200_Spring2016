...
public class Driver 
{
	public static void main(String[] args) 
 	...
 	{ 
 	    ...
 	    Driver.mergeHelper(a, begin,  middle, b); 
 	    Driver.mergeHelper(a, middle,    end, b); 
 	    Driver.display(a, begin, middle, end, b); 
 	    Driver.copyArray(b, begin, end, a); 
 	} 
 	static void display(int a[], int begin, int middle, int end, int b[]) 
 	{ 
 	    int i = begin; 
 	    int j = middle; 
